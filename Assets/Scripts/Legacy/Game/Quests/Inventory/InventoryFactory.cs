...
namespace GameModel.Quests
{
    public class InventoryFactory
    {
        ...
        // Pass _database to check economy settings
        public IInventory CreateBlackMarketPlayerInventory(int starId)
        {
            return new BlackMarketPlayerInventory(_productFactory, _playerResources, _itemTypeFactory, _database);
        }
        ...
        {
            return new IapInventory(_productFactory, _inAppPurchasing, _adsManager, _itemTypeFactory, _holidayManager);
        }
