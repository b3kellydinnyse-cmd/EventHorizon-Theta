...
namespace Gui.ShipService
{
    public class UpgradePanel : MonoBehaviour
    {
        ...
        // Check if shipyard cell upgrades can use stars from database settings
        private bool IsStarsAllowed => _database.EconomySettings == null ||
            (_database.EconomySettings.EnablePremiumCurrency && _database.EconomySettings.EnableShipUpgradesWithStars);
        ...
        public void Initialize(IShip ship, Faction faction, int level)
        {
            ...
            _shipInfo = new ShipInformation(_ship, _faction, _level, IsStarsAllowed);
        ...
        private void UpdateControls()
        {
            ...
            else
            {
                ...
                _price2.gameObject.SetActive(IsStarsAllowed);
            ...
            if (_shipInfo.CanReset)
                ...
                _price3.Initialize(IsStarsAllowed ? Currency.Stars : Currency.Credits);
        ...
        {
            public ShipInformation(IShip ship, Faction shipyardFaction, int shipyardLevel, bool starsAllowed)
            {
                ...
                // Compute prices based on database toggle
            ...
            public bool CanReset => Cells > 0;
            public bool IsShipLevelEnough => _shipLevel >= RequiredLevel;
