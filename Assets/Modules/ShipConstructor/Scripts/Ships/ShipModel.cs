    ...
    public sealed class ShipModel : IShipModel
    {
        ...
        private void OnModificationsChanged()
        {
            _stats = new ShipBaseStats
            {
                ...
                // Added new drone bonuses
                DroneRangeMultiplier = new StatMultiplier(_ship.Features.DroneRangeBonus),
                DroneSpeedMultiplier = new StatMultiplier(_ship.Features.DroneSpeedBonus),
                DronesBuiltPerSecondMultiplier = _ship.Features.DronesBuiltPerSecondBonus,
                DroneCapacityBonus = (int)_ship.Features.DroneCapacityBonus,
