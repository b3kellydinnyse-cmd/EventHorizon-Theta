...
namespace Constructor
{
    ...
    namespace Detail
    {
        public class WeaponPlatform : IWeaponPlatformData, IWeaponPlatformStats
        {
            ...
            public float AoeMultiplier { get; set; }
            public float ImpulseMultiplier { get; set; }
            ...
            public IEnumerable<IWeaponData> Weapons
            {
                get
                {
                    foreach (var item in _weapons)
                    {
                        ...
                        item.VelocityMultiplier = VelocityMultiplier;
                        item.AoeMultiplier = AoeMultiplier;
                        item.ImpulseMultiplier = ImpulseMultiplier;
                        yield return item;
                    }
                }
            }
            ...
            public class WeaponData : IWeaponData
            {
                ...
                public WeaponStatModifier Stats
                {
                    get
                    {
                        ...
                        stats.VelocityMultiplier *= VelocityMultiplier;
                        stats.AoeRadiusMultiplier *= AoeMultiplier;
                        stats.WeightMultiplier *= ImpulseMultiplier;
                        return stats;
                    }
                }
            ...
            public class WeaponDataObsolete : IWeaponDataObsolete
            {
                ...
                public AmmunitionObsoleteStats Ammunition
                {
                    get
                    {
                        ...
                        stats.AreaOfEffect *= AoeMultiplier;
                        stats.Impulse *= ImpulseMultiplier;
                        return stats;
                    }
                }
        ...
        public class ShipBuilderResult : IShipSpecification
        {
            ...
            public void ApplyStats(ShipStatsCalculator stats)
            {
                foreach (var platform in _platforms)
                {
                    ...
                    platform.VelocityMultiplier = stats.EquipmentStats.WeaponVelocityMultiplier.Value;
                    platform.AoeMultiplier = stats.EquipmentStats.WeaponAoeMultiplier.Value;
                    platform.ImpulseMultiplier = stats.EquipmentStats.WeaponImpulseMultiplier.Value;
                }
