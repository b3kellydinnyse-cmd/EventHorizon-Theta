...
namespace Constructor
{
    ...
    {
        // Global toggle to allow premium prices for components
        public static bool AllowPremiumPrices = true;
        ...
        [Obsolete]
        public int SerializeToInt32Obsolete()
        {
#if UNITY_EDITOR
        ...
        // Refactored PremiumPrice property
        public Economy.Price PremiumPrice
        {
            get
            {
                ...
                if (AllowPremiumPrices)
                {
                    // Return star price if premium components are allowed
                    return Economy.Price.Premium(Data.PremiumPriceInStas(quality));
                }
                else
                {
                    // Fallback to credits if disabled
