    ...
    public partial class Database : IDatabase
    {
		...
		public class Loader
        {
			...
			public void Load()
            {
				...
				if (_database.EconomySettings == null)
					_database.EconomySettings = EconomySettings.Create(_content.EconomySettings ?? new Serializable.EconomySettingsSerializable { ItemType = Enums.ItemType.EconomySettings }, this);
