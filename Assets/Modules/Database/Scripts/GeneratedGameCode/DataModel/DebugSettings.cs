...
namespace GameDatabase.DataModel
{
	public partial class DebugSettings 
	{
		...
		private DebugSettings(DebugSettingsSerializable serializable, Database.Loader loader)
		{
			...
			EnableDebugCheats = serializable.EnableDebugCheats;
			EnableDevCodesConsole = serializable.EnableDevCodesConsole;
		...
		public bool EnableDebugCheats { get; private set; }
		public bool EnableDevCodesConsole { get; private set; }
