...
namespace GameDatabase.DataModel
{
	public partial class CombatSettings 
	{
		...
		private CombatSettings(CombatSettingsSerializable serializable, Database.Loader loader)
		{
			...
			DefaultCombatRules = loader?.GetCombatRules(new ItemId<CombatRules>(serializable.DefaultCombatRules)) ?? CombatRules.DefaultValue;
			UseDynamicPhysicsLimits = serializable.UseDynamicPhysicsLimits;
		...
		public CombatRules DefaultCombatRules { get; private set; }
		public bool UseDynamicPhysicsLimits { get; private set; }
