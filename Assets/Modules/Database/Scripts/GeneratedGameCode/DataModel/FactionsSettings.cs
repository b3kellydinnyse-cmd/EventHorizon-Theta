...
namespace GameDatabase.DataModel
{
	public partial class FactionsSettings : IDefaultVariablesResolver
	{
		...
		private FactionsSettings(FactionsSettingsSerializable serializable, Database.Loader loader)
		{
			...
			HideUndiscoveredFactionsInTechTree = serializable.HideUndiscoveredFactionsInTechTree;
		...
		public bool HideUndiscoveredFactionsInTechTree { get; private set; }
		...
		private class VariableResolver : IVariableResolver
		{
			...
			public Expression<Variant> ResolveVariable(string name)
			{
				...
				if (name == "HideUndiscoveredFactionsInTechTree") return GetHideUndiscoveredFactionsInTechTree;
			...
			private Variant GetHideUndiscoveredFactionsInTechTree() => _context.HideUndiscoveredFactionsInTechTree;
		}
	}
}
