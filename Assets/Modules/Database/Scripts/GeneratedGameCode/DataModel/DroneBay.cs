...
namespace GameDatabase.DataModel
{
	...
	public partial struct DroneBayStats 
	{
		...
		public DroneBayStats(DroneBaySerializable serializable, Database.Loader loader)
		{
			...
			BuildReserve = serializable.BuildReserve;
			ReserveCapacity = UnityEngine.Mathf.Clamp(serializable.ReserveCapacity, -1, 100);
			ActivationType = serializable.ActivationType;
			LaunchDelay = UnityEngine.Mathf.Clamp(serializable.LaunchDelay, 0f, 10f);
